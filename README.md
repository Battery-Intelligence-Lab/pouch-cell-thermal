...
# Data: 
The data may be found at [10.5287/ora-eonzaxjpm](https://doi.org/10.5287/ora-eonzaxjpm)
...
|                   | File path (inside data/exp) | Experiment                  |
|-------------------|-----------------------------|-----------------------------|
...
## Acknowledgements
VK was funded by the EPSRC DIGEST project (ref. [EP/W027321/1](https://gtr.ukri.org/projects?ref=EP%2FW027321%2F1)), UKRI's Horizon Europe Guarantee (ref. 10107050), and the Horizon EU DigiBatt project (ref. 101103997). ET acknowledges funding for this work that was partially provided for by the Faraday Institution project `Nextrode - next generation electrodes` (grant number FIRG015 and FIRG066).

## License and copyright
Dataset is licensed under Creative Commons Attribution 4.0 (CC BY 4.0). See [10.5287/ora-eonzaxjpm](https://doi.org/10.5287/ora-eonzaxjpm)

The code is licensed under BSD-3 clause. See LICENSE file for details. 